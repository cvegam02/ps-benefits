...
export const products: Product[] = [
  // Calzado
  {
    ...
    sku: "1204452",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1204452-1.jpg",
  ...
  },
  {
    ...
    sku: "1090089",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/0/1090089-1.jpg",
  ...
  },
  {
    ...
    sku: "1262107",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1262107-0.jpg",
  ...
  },
  {
    ...
    sku: "1135759",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/1/1135759-0.jpg",
  ...
  },
  {
    ...
    sku: "180626",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/8/180626-1.jpg",
  ...
  // Ropa
  {
    ...
    sku: "1225287",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1225287-1.jpg",
  ...
  },
  {
    ...
    sku: "1247577",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1247577-1.jpg",
  ...
  },
  {
    ...
    sku: "1218710",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1218710-1.jpg",
  ...
  },
  {
    ...
    sku: "1093845",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/0/1093845-1.jpg",
  ...
  // Accesorios
  {
    ...
    sku: "1257960",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1257960-1.jpg",
  ...
  },
  {
    ...
    sku: "1222260",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1222260-1.jpg",
  ...
  },
  {
    ...
    sku: "1222291",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1222291-1.jpg",
  ...
  },
  {
    ...
    sku: "1222298",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1222298-1.jpg",
  ...
  },
  {
    ...
    sku: "1222278",
    image: "https://res.cloudinary.com/priceshoes/w_750,f_auto,q_auto:best/product/1/2/1222278-1.jpg",
...
export function getProductImageUrl(url: string | undefined, size: "thumb" | "full" = "full"): string {
  ...
  // Si es URL de la API (contiene q_auto:eco), mejorar calidad
  if (url.includes("q_auto:eco")) {
    const width = size === "thumb" ? 256 : 750
    const quality = size === "thumb" ? "good" : "best"
    return url.replace(/w_\d+/, `w_${width}`).replace(/q_auto:\w+/, `q_auto:${quality}`)
  }
  
  // Si es URL local (contiene q_auto:best), usar el tamaño correcto
  if (size === "thumb") {
    return url.replace(/w_\d+/, "w_256").replace(/q_auto:\w+/, "q_auto:good")
  }
  return url
}
